...
export const metadata: Metadata = {
  ...
  description: "Learn how Rebirth fits into TNT Incremental progression without relying on fake requirements or multiplier formulas.",
...
export default function RebirthGuidePage() {
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <PageIntro eyebrow="Permanent multipliers" title="TNT Incremental Rebirth Guide" description="The official Roblox page confirms Rebirth resets for permanent multipliers. This guide focuses on the decision pattern and holds exact requirements until they are tested." />
